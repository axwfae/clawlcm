...
> **版本**: v0.8.1 | **更新日**: 2026-04-15 | **參考**: [lossless-claw-enhanced](https://github.com/win4r/lossless-claw-enhanced) | **基於**: picolcm

基於 [lossless-claw-enhanced](https://github.com/win4r/lossless-claw-enhanced) 增強的超輕量級無損上下文管理系統。
...
基於 [lossless-claw-enhanced](https://github.com/win4r/lossless-claw-enhanced) 增強，這是 OpenClaw 的 LCM (Lossless Context Management) 插件。
是 picolcm 的增強版本，加入了多個修復和優化。

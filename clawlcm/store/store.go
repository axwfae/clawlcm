...
func (s *Store) GetConversationBySessionKey(sessionKey string) (*types.Conversation, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get conversation by session key %s: %w", sessionKey, err)
	}
...
func (s *Store) GetConversationByID(id int64) (*types.Conversation, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get conversation by id %d: %w", id, err)
	}
	return toConversation(&model), nil
}
...
func (s *Store) GetSummaries(conversationID int64) ([]types.SummaryRecord, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get summaries for conversation %d: %w", conversationID, err)
	}
...
func (s *Store) GetSummaryByID(id int64) (*types.SummaryRecord, error) {
	...
	err := s.db.First(&model, id).Error
	if err != nil {
		return nil, fmt.Errorf("get summary by id %d: %w", id, err)
	}
...
func (s *Store) GetLeafSummaries(conversationID int64) ([]types.SummaryRecord, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get leaf summaries for conversation %d: %w", conversationID, err)
	}
	return toSummaries(models), nil
}
...
func (s *Store) GetCondensedSummaries(conversationID int64) ([]types.SummaryRecord, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get condensed summaries for conversation %d: %w", conversationID, err)
	}
	return toSummaries(models), nil
}
...
func (s *Store) GetSummariesByDepth(conversationID int64, depth int) ([]types.SummaryRecord, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get summaries by depth %d for conversation %d: %w", depth, conversationID, err)
	}
	return toSummaries(models), nil
}
...
func toSummaries(models []db.SummaryModel) []types.SummaryRecord {
	...
	for i, m := range models {
		...
		if err := json.Unmarshal([]byte(m.ParentIDs), &parentIDs); err != nil {
			parentIDs = nil
		}
		if err := json.Unmarshal([]byte(m.SourceIDs), &sourceIDs); err != nil {
			sourceIDs = nil
		}
